...
```bash
/plugin install https://github.com/nikiforovall/claude-code-rules/tree/main/plugins/handbook-context7
```
...
If you previously used Context7 through the `handbook` plugin, you now need to install this dedicated plugin. Context7 has been moved to its own plugin for better modularity.
