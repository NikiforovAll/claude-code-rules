...
1. **Phase 1 - Setup**: Create plan skeleton with Research section
2. **Phase 2 - Research**: Explore codebase, propose strategies, iterate with user
3. **Phase 3 - Finalize Selected Approach**: Document selected approach with rationale
...
**Phase 1**: Create plan with Phase 0 Research section
...
**Phase 3**: Document selected approach with rationale in the Selected Approach section
