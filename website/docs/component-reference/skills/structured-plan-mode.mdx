...
import StructuredPlanModeSource from '!!raw-loader!../../../../plugins/handbook-structured-plan-mode/skills/structured-plan-mode/SKILL.md'
import CodeBlock from '@theme/CodeBlock';

# Use `structured-plan-mode` skill

<span className="badge badge--handbook-structured-plan-mode">handbook-structured-plan-mode</span>
