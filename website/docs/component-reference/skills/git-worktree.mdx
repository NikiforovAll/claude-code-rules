...
import GitWorktreeSource from '!!raw-loader!../../../../plugins/handbook-git-worktree/skills/git-worktree/SKILL.md'
import CodeBlock from '@theme/CodeBlock';

# Use `git-worktree` skill

<span className="badge badge--handbook-git-worktree">handbook-git-worktree</span>
