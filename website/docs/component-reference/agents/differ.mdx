...
import DifferAgentSource from '!!raw-loader!../../../../plugins/handbook/agents/differ.md'
...
The `@differ` agent specializes in comparing branches and producing structured, one-page summaries showing file-level changes, statistics, and high-level impact analysis. It uses the Haiku model for speed and cost efficiency, making it ideal for routine PR reviews and quick branch comparisons.

## When to Use This Agent

Use the `@differ` agent when you need to:
...
```
Use @differ to summarize my changes
```

**Custom target branch**:
```
Use @differ to compare against main
```
